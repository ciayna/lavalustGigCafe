    ...
    <main class="main-content">
      ...
      <div style="padding: 20px" class="container-fluid px-4">
			<div class="table-title">
						<h2 style="float:inline-start; margin: 5px">Manage Reservations</h2>
						<a style="background: #ea6a12; border: none; float:inline-end; margin: 5px" href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Reservation</span></a>				
			</div>
            ...
            <td><?= $val['date']; ?></td>
                        ...
                        <td><?= $val['status']; ?></td>
						<td>
							<a style=" text-decoration: none" href='<?= base_url(); ?>/editview/<?= $val['id']; ?>' class="modal-edit 1">
								<i style="color: #ea6a12; text-decoration: none" class="material-icons"  title="Edit">edit</i>
							</a>
							<a href='<?= base_url(); ?>/delete/<?= $val['id']; ?>' class="delete">
								<i style="color: #ea6a12; text-decoration: none" class="material-icons" title="Delete">delete</i>
							</a>
						</td>
					</tr>
				<?php endforeach; ?>
			...
			<form action="/save" method="post">
				...
				<div class="modal-body">					
                    ...
                    <div class="form-group">
						<label>Event</label>
                        <br>    
						<select name="event" style="width: 470px; height: 40px; border-radius: 5px; border: F#dadfe3" class="form-group">
