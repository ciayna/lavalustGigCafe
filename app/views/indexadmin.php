...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="public/admin/assets/css/core/libs.min.css">
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="public/admin/assets/css/aprycot.min.css?v=1.0.0">  
  ...
  <body class="  "  style="background:url(public/admin/assets/images/dashboard.png);    background-attachment: fixed;
    ...
    <aside class="sidebar sidebar-default sidebar-hover sidebar-mini navs-pill-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="public/admin/dashboard/index.html" class="navbar-brand">
            ...
            <div class=" navbar-collapse" id="sidebar">
                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item sub-nav">
                        <a class="nav-link active" aria-current="page" href="public/admin/dashboard/index.html">
                             <i class="icon">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link" href="public/admin/dashboard/auth/sign-in.html">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="public/admin/dashboard/auth/sign-up.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="public/admin/dashboard/auth/confirm-mail.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="public/admin/dashboard/auth/recoverpw.html">
                                   <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/app/user-profile.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/app/user-add.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/app/user-list.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/errors/error404.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/errors/error500.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="public/admin/dashboard/errors/maintenance.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item sub-nav">
                        <a class="nav-link " href="public/admin/dashboard/icons/dual-tone.html">
                            <i class="icon">
              ...
              <ul class="navbar-nav ms-auto align-items-center navbar-list mb-2 mb-lg-0">
                        ...
                        <div class="card-body p-0">
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill" src="public/admin/assets/images/layouts/01.png" alt="">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <div class="">
                                    <img class="avatar-40 rounded-pill" src="public/admin/assets/images/layouts/02.png" alt="">
                                  </div>
                                  <div class="ms-3 w-100">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill" src="public/admin/assets/images/layouts/03.png" alt="">
                                  <div class="ms-3 w-100">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill" src="public/admin/assets/images/layouts/04.png" alt="">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="public/admin/assets/images/avatars/01.png" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="public/admin/dashboard/app/user-profile.html">Profile</a></li>
                    <li><a class="dropdown-item" href="public/admin/dashboard/app/user-privacy-setting.html">Privacy Setting</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="public/admin/dashboard/auth/sign-in.html">Logout</a></li>
                  </ul>
                </li>
              </ul>
            </div>
...
<div class="row">
   <div class="col-md-12 col-lg-8">
      <div class="card ">
         <div class="hero-image p-3" style="background: url('public/admin/assets/images/layouts/01.png') no-repeat center right;background-size: cover;background-position: center;">
               ...
               <div class="swiper-wrapper">
                     ...
                     <div class="card active category-menu">
                        <div class="card-body">
                           <div class="text-center">
                              <img src="public/admin/assets/images/layouts/1.png" alt="header" class="img-fluid rounded-pill mb-3">
                     ...
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/2.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/3.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/4.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/5.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/6.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     <div class="card category-menu">
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="public/admin/assets/images/layouts/7.png" alt="header" class="img-fluid rounded-pill mb-3">
            ...
            <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
               <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                  <div class="col active">
                     <div class="card card-white dish-card profile-img mb-0 index">
                         <div class="profile-img21">
                             <img src="public/admin/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="public/admin/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                         </div>
                  ...
                  <div class="col">
                     <div class="card card-white dish-card profile-img mb-0 index">
                         <div class="profile-img21">
                             <img src="public/admin/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="public/admin/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                         </div>
                         <div class="card-body menu-image">
                  ...
                  <div class="col">
                     <div class="card card-white dish-card profile-img mb-0 active">
                         <div class="profile-img21">
                             <img src="public/admin/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="public/admin/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                         </div>
                         <div class="card-body menu-image">
                  ...
                  <div class="col">
                     <div class="card card-white dish-card profile-img mb-0 index">
                         <div class="profile-img21">
                             <img src="public/admin/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="public/admin/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 " alt="profile-image">
                         </div>
                         <div class="card-body menu-image">
                  ...
                  <div class="swiper-slide">
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                                         <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="swiper-slide">
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                                         <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                                         <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="swiper-slide">
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                                         <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="public/admin/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="public/admin/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 " alt="profile-image">
                                 </div>
                                 <div>
                                     <span class="text-primary">
                                         <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="col-md-12 col-lg-4 mt-5">
      <div class="row">
               ...
               <div class="card-body">
                  <div class="text-center profile-img51">
                     <div class="profile-img41 ">
                        <img src="public/admin/assets/images/layouts/8.png" class="img-fluid rounded-pill " alt="profile-image">
                     </div>
               ...
               <div class="card-body">
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4">
                        <div class="profile-img11">
                           <img src="public/admin/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="public/admin/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115"  alt="img">
                        </div>
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="public/admin/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="public/admin/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115"  alt="img">
                        </div>
                        <div class="d-flex align-items-center profile-content">
                           <div>
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="public/admin/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="public/admin/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115"  alt="img">
                        </div>
                        <div class="d-flex align-items-center profile-content">
                           <div>
                  ...
                  <div class="text-center mt-5">
                     <a type="button" href="public/admin/dashboard/special-pages/add-to-cart.html" class="btn btn-primary rounded-pill">Checkout</a>
                  </div>   
               </div>
            </div>
         </div>
         <div class="col-md-12 col-lg-12">
            <div class="card iq-glass-card rounded border border-white">
             ...
             <div class="position-relative">
                  <img src="public/admin/assets/images/layouts/40.png" alt="img-1" class="img-fluid img-user">
               </div>
         </div>
      </div>
   </div>
      ...
      <footer class="footer">
          <div class="footer-body">
              <ul class="left-panel list-inline mb-0 p-0">
                  <li class="list-inline-item"><a href="public/admin/dashboard/extra/privacy-policy.html">Privacy Policy</a></li>
                  <li class="list-inline-item"><a href="public/admin/dashboard/extra/terms-of-service.html">Terms of Use</a></li>
              </ul>
    ...
    <script src="public/admin/assets/js/core/libs.min.js"></script>
    
    <!-- External Library Bundle Script -->
    <script src="public/admin/assets/js/core/external.min.js"></script>
    
    <!-- Mapchart JavaScript -->
    <script src="public/admin/assets/js/charts/dashboard.js"></script>
    
    <!-- fslightbox JavaScript -->
    <script src="public/admin/assets/js/fslightbox.js"></script>
    
    <!-- app JavaScript -->
    <script src="public/admin/assets/js/app.js"></script>
    
    <!-- moment JavaScript -->
    <script src="public/admin/assets/vendor/moment.min.js"></script>  </body>
</html>