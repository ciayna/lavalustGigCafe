...
<head>
    ...
    <link rel="shortcut icon" href="public/CRS/catering.png">
  <link rel="apple-touch-icon" href="public/CRS/catering.png">
  <link rel="icon" href="public/CRS/favicon.ico" type="image/x-icon">
</head>
<body>
<?php 
    ...
    if(!empty($_SESSION['user_login']) && !empty($_SESSION["email"])){
        ...
        $loginButton = '<li class="nav-item"><a class="nav-link" href="/login">Log in</a></li>';
        $button = '<a class="btn btn-primary shadow" role="button" href="/signup">Sign up</a>';
    }
...
<nav class="navbar navbar-dark navbar-expand-md sticky-top py-3" id="mainNav">
    ...
    <img src="public/CRS/catering.png" width="40">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="/home" id="home">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="/packages" id="packages">Packages</a></li>
                <li class="nav-item"><a class="nav-link" href="/crew" id="crew">Crew</a></li>
                <li class="nav-item"><a class="nav-link" href="/contacts" id="contacts">Contacts</a></li>
